...
if ( ! class_exists( 'CBXMCRatingReviewEmailEmogrifier' ) ):
	class CBXMCRatingReviewEmailEmogrifier {
		/**
		 * @var string
		 */
		...
		private function translateCssToXpath( $paramCssSelector ) {
			...
			if ( ! isset( $this->caches[ self::CACHE_KEY_XPATH ][ $xpathKey ] ) ) {
				...
				$cssSelector = preg_replace_callback( self::ID_ATTRIBUTE_MATCHER, array(
					$this,
					'matchIdAttributes'
				), $cssSelector );
				$cssSelector = preg_replace_callback( self::CLASS_ATTRIBUTE_MATCHER, array(
					$this,
