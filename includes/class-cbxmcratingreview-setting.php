 ...
 */
if ( ! class_exists( 'CBXMCRatingReviewSettings' ) ):

	class CBXMCRatingReviewSettings {
		...
		function callback_file_extensions_checker( $args ) {
			...
			$image_ext_arr = CBXMCRatingReviewHelper::imageExtArr(); //todo:
		...
		function callback_file( $args ) {
			...
			$label = isset( $args['options']['button_label'] ) ?
				...
				esc_html__( 'Choose File', 'cbxmcratingreview' );
		...
		function show_forms() {
            ...
            <div class="metabox-holder">
				<?php foreach ( $this->settings_sections as $form ) { ?>
                    <div id="<?php echo $form['id']; ?>" class="cbxmcratingreview_setting_group" style="display: none;">
                        <form method="post" action="options.php">
							<?php
							do_action( 'cbxmcratingreview_review_form_top_' . $form['id'], $form );
							settings_fields( $form['id'] );
							do_settings_sections( $form['id'] );
							do_action( 'cbxmcratingreview_review_form_bottom_' . $form['id'], $form );
							?>
