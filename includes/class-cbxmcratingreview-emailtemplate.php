...
class CBXMCRatingReviewEmailTemplate {

	public $settings_api;

	public function __construct() {

		$this->settings_api = new CBXMCRatingReviewSettings();
	}

	public function emailGetHeader() {
		$direction   = 'ltr'; //$doc->direction;
		$sitename    = get_bloginfo( 'name' ); //$config->get('sitename');
		$headerimage = $this->settings_api->get_option( 'headerimage', 'cbxmcratingreview_global_email', '' );
	...
	public function emailGetFooter() {
		...
		$sitename    = get_bloginfo( 'name' ); //$config->get('sitename');
		$headerimage = $this->settings_api->get_option( 'headerimage', 'cbxmcratingreview_global_email', '' );
		$footertext  = str_replace( '{sitename}', get_bloginfo( 'name' ), $this->settings_api->get_option( 'footertext', 'cbxmcratingreview_global_email', '{sitename}' ) );
	...
	public function emailGetStyle() {
		...
		// Load colours
		$base = $this->settings_api->get_option( 'basecolor', 'cbxmcratingreview_global_email', '#557da1' );
		$bg   = $this->settings_api->get_option( 'backgroundcolor', 'cbxmcratingreview_global_email', '#f5f5f5' );

		$body      = $this->settings_api->get_option( 'bodybackgroundcolor', 'cbxmcratingreview_global_email', '' );
		$base_text = $this->settings_api->get_option( 'bodytextcolor', 'cbxmcratingreview_global_email', '#fdfdfd' );
		$text      = $base_text;
	...
	public function htmlEmeilify( $html ) {
		...
		try {
			...
			$emogrifier = new CBXMCRatingReviewEmailEmogrifier( $html, $css );
